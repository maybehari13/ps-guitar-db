...
public class ModelTypePersistenceTests {
	...
	@Test
	public void testFindByNameIsNull() throws Exception {
		List<ModelType> mt = modelTypeJpaRepository.findByNameIsNull();
		assertEquals(1, mt.size());
	}
	
	@Test
	public void testFindByNameIsNotNull() throws Exception {
		List<ModelType> mt = modelTypeJpaRepository.findByNameIsNotNull();
		assertEquals(7, mt.size());
	}
}
